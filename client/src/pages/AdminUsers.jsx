...
export default function AdminUsers() {
    ...
    const { data: users = [], isLoading: loadingUsers } = useQuery({
        ...
        queryFn: () => api.get('/auth/users').then(res => res.data), // Need to create this endpoint
        enabled: !!user
    });
                                            ...
                                            >
                                                <TableCell>
                                                    <div className="flex items-center gap-3">
                                                        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-lime-400 to-green-600 flex items-center justify-center text-slate-900 font-medium shadow-lg shadow-lime-500/20">
                        ...
                        {selectedUser && (
                            <div className="space-y-6">
                                <div className="flex items-center gap-4">
                                    <div className="w-16 h-16 rounded-full bg-gradient-to-br from-lime-400 to-green-600 flex items-center justify-center text-slate-900 text-2xl font-bold shadow-xl shadow-lime-500/20">
                                    ...
                                    <div>
                                        ...
                                        <Badge className="mt-1 bg-slate-900">{selectedUser.role || 'user'}</Badge>
                                    </div>
                                </div>

                                <div className="grid grid-cols-2 gap-4">
                                    <div className="p-4 bg-lime-50 rounded-xl text-center border border-lime-100">
                                        <Calendar className="w-6 h-6 text-lime-600 mx-auto mb-2" />
                                        <p className="text-2xl font-bold text-lime-700">{selectedUser.stats.paid}</p>
                                        <p className="text-sm text-lime-600">Reservas completadas</p>
                                    </div>
